...
import { useMDXComponents as r } from "./index-C2EhqCXm.js";
import { b as a } from "./blocks-LDAL-hRz.js";
...
function o(t) {
  const i = { code: "code", h1: "h1", p: "p", ...r(), ...t.components };
...
function E(t = {}) {
  const { wrapper: i } = { ...r(), ...t.components };
  return i ? e.jsx(i, { ...t, children: e.jsx(o, { ...t }) }) : o(t);
}
export { s as RightArrow, E as default };
