import { a as yc } from "./iframe-D4KGjs-o.js";
var hi = { exports: {} },
  ve = {},
  yi = { exports: {} },
  gi = {};
  ...
  function Va(e, n, t, r, l) {
    switch (n) {
      ...
      case "gotpointercapture":
        return (
          (u = l.pointerId),
          It.set(u, jt(It.get(u) || null, e, n, t, r, l)),
          !0
        );
    }
    return !1;
    ...
    Ii(function () {
      ...
      e: {
        ...
        if (m !== void 0) {
          ...
          0 < C.length &&
            ((m = new g(m, S, null, t, v)), h.push({ event: m, listeners: C }));
        }
      }
      if ((n & 7) === 0) {
        e: {
        ...
        return (
          (n =
            n.nodeType !== 1 || t.toLowerCase() !== n.nodeName.toLowerCase()
              ...
              : n),
          n !== null
            ? ((e.stateNode = n), (ge = e), (we = hn(n.firstChild)), !0)
            : !1
        );
      case 6:
        return (
    ...
    function g(f, a, c, y, x) {
      ...
      if (typeof y == "object" && y !== null) {
        switch (y.$$typeof) {
          case on:
            return (
              (f = f.get(y.key === null ? c : y.key) || null),
              s(a, f, y, x)
            );
          case Te:
            return (
