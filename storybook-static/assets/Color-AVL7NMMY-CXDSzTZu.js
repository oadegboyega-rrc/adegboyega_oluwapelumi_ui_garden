import {
  ...
  _ as be,
  a as q,
} from "./blocks-LDAL-hRz.js";
import { r as p, e as v } from "./iframe-D4KGjs-o.js";
import "./jsx-runtime-Dl-HaM7H.js";
import "./index-AXVIp834.js";
var ve = q({
...
var $ = function (r, l, s) {
      ...
      a = p.useMemo(
        function () {
          ...
          function b(y) {
            var m = t.current,
              k = B(u.current),
              E = y ? k.addEventListener : k.removeEventListener;
            (E(m ? "touchmove" : "mousemove", f),
  ...
  te = v.memo(function (r) {
    var l = r.hsva,
      s = r.onChange,
      h = { backgroundColor: X({ h: l.h, s: 100, v: 100, a: 1 }) };
    return v.createElement(
      "div",
  ...
  Oe = function (r, l) {
    return r.toLowerCase() === l.toLowerCase() || ne(K(r), K(l));
  };
function le(r, l, s) {
  var h = L(s),
...
var $e = typeof window < "u" ? p.useLayoutEffect : p.useEffect,
  Ne = function () {
  ...
  Se = function (r) {
    var l = r.className,
      ...
      d = r.onChange,
      e = V(r, ["className", "colorModel", "color", "onChange"]),
      n = p.useRef(null);
    oe(n);
    var t = le(s, u, d),
      a = t[0],
  ...
  Re = function (r) {
    return v.createElement(Se, C({}, r, { colorModel: je }));
  },
  ze = function (r) {
    var l = r.className,
      s = r.hsva,
  ...
  Ie = function (r) {
    return v.createElement(ue, C({}, r, { colorModel: He }));
  },
  qe = {
  ...
  Pe = function (r) {
    return v.createElement(ue, C({}, r, { colorModel: qe }));
  },
  Le = M.div({
    position: "relative",
    maxWidth: 250,
  ...
  Xe = M(fe)(({ theme: r }) => ({ fontFamily: r.typography.fonts.base })),
  Ge = M.div({
    display: "grid",
  ...
  Fe = M(de.Input)(({ theme: r, readOnly: l }) => ({
    width: "100%",
    paddingLeft: 30,
    paddingRight: 30,
  ...
  G = /^\s*#?([0-9a-f]{3}|[0-9a-f]{6})\s*$/i,
  Ye = /^\s*#?([0-9a-f]{3})\s*$/i,
  Je = { hex: Re, rgb: Pe, hsl: Ie },
  z = {
    hex: "transparent",
    rgb: "rgba(0, 0, 0, 0)",
    hsl: "hsla(0, 0%, 0%, 0)",
  ...
  se = (r) => {
    let l = r == null ? void 0 : r.match(We);
    if (!l) return [0, 0, 0, 1];
    let [, s, h, u, d = 1] = l;
  ...
  rr = (r, l, s) => {
    if (!r || !(l != null && l.valid)) return z[s];
  ...
  tr = (r, l) => {
    let [s, h] = p.useState(r || ""),
      [u, d] = p.useState(() => O(s)),
      [e, n] = p.useState((u == null ? void 0 : u.colorSpace) || "hex");
    p.useEffect(() => {
      let i = r || "",
        c = O(i);
    ...
    let t = p.useMemo(() => rr(s, u, e).toLowerCase(), [s, u, e]),
      ...
      o = p.useCallback(() => {
        let i = (P.indexOf(e) + 1) % P.length,
          c = P[i];
        n(c);
        let f = (u == null ? void 0 : u[c]) || "";
        (h(f), l(f));
      }, [u, e, l]);
    return {
      value: s,
  ...
  ar = ({
    ...
    let t = p.useCallback(ce(s, 200), [s]),
      ...
      m = Je[f],
      k = !!((E = n == null ? void 0 : n.table) != null && E.readonly);
    return v.createElement(
      Le,
      { "aria-readonly": k },
      v.createElement(
