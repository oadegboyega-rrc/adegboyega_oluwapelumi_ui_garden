try {
  (() => {
    ...
    var pa = __STORYBOOK_API__,
      {
        ...
        experimental_getTestProviderStore: Ta,
        experimental_requestResponse: wa,
        experimental_useStatusStore: Pa,
        experimental_useTestProviderStore: ka,
    ...
    function me(e, t, r) {
      ...
      return (r && C(n, r.prototype), n);
    }
    function D(e) {
      var t = typeof Map == "function" ? new Map() : void 0;
      return (
        (D = function (r) {
          if (r === null || !ce(r)) return r;
...
`,
    ...
    var b = (function (e) {
      ...
      function t(r) {
        for (
          var a, n = arguments.length, o = new Array(n > 1 ? n - 1 : 0), s = 1;
          s < n;
          s++
        )
          o[s - 1] = arguments[s];
        return (
          (a = e.call(this, be.apply(void 0, [he[r]].concat(o))) || this),
          de(a)
        );
      }
      return t;
    ...
    function S(e) {
      ...
      var f = ke.exec(t.substring(0, 50));
      if (f) {
    ...
    function se(e, t, r) {
      return function () {
        ...
        return a.length >= t ? e.apply(this, a) : se(e, t, a);
      };
    }
    function c(e) {
    ...
    function We(e, t) {
      return t === "transparent"
        ? t
        : y(d({}, g(t), { lightness: parseFloat(e) }));
    }
    c(We);
    function Ye(e, t) {
      return t === "transparent"
        ? t
        : y(d({}, g(t), { saturation: parseFloat(e) }));
    }
    c(Ye);
    function Ge(e, t) {
    ...
    function Ke(e, t) {
      return t === "transparent"
        ? t
        : ie(parseFloat(e), "rgb(255, 255, 255)", t);
    }
    c(Ke);
    function Ue(e, t) {
      if (t === "transparent") return t;
      var r = S(t),
        a = typeof r.alpha == "number" ? r.alpha : 1,
        n = d({}, r, {
          alpha: T(0, 1, +(a * 100 - parseFloat(e) * 100).toFixed(2) / 100),
        });
      return F(n);
    }
    var Ze = c(Ue),
