...
const skills: SkillItem[] = [
  {
    ...
    description: "Primary tools for development",
    items: ["JavaScript", "TypeScript", "React", "Node.js"],
  },
  {
    category: "Tools",
    description: "Ecosystem and tooling",
    items: ["GitHub Actions", "Docker", "Storybook", "Jest", "ESLint"],
  },
];
...
const resources: ResourceItem[] = [
  {
    ...
    summary: "Source control and CI",
    link: "https://github.com",
  },
  {
    title: "Storybook",
    image:
      "https://raw.githubusercontent.com/storybookjs/brand/main/badge/badge-storybook.svg",
    summary: "Component docs and playground",
...
export default function App(): JSX.Element {
  return (
    ...
    >
      ...
      >
        <HeroImage
          src="https://picsum.photos/seed/profile/1200/300"
          alt="Profile"
        />
        <div>
          <h1 style={{ margin: 0 }}>Adegboyega Oluwapelumi</h1>
          <p style={{ margin: "4px 0 0" }}>
            Frontend Engineer • UI Components • Testing
          </p>
        </div>
      </header>
